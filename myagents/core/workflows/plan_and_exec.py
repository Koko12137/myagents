...
class MemoryPlanAndExecFlow(MemoryTreeTaskReActFlow):
    """MemoryPlanAndExecFlow is a workflow for splitting a task into sub-tasks and executing the sub-tasks with memory.
    """
    agent: MemoryAgent
    ...
    def get_memory_agent(self) -> MemoryAgent:
        """Override the get_memory_agent method of the plan and exec workflow.
        """
        return self.agent
