...
3. **节点问题名称规则**
⛔ 严令禁止在节点的问题名称上使用特殊符号或者其他引起解析错误的字符（如⛔反斜杠，⛔花括号，⛔数学公式，⛔数学符号）
...
‼️ 注意：任何数学公式都不要出现在标题里
‼️ 注意：你不需要复述用户的问题和描述，你的所有规划都会被认为是用户的问题和描述的子问题
- [ ] 目标Objective 1（⛔禁止特殊符号，尤其是反斜杠，花括号，数学公式，数学符号，这是第一层子问题）
    - 描述：需求的具体描述，关键产出(KR)是什么，完成标准(CR)是什么，怎么判断是否正确完成
    - 是否叶子：False  // 非叶子任务，需要继续拆解
    - 子任务：
        - [ ] 目标Objective 1.1（⛔禁止特殊符号，尤其是反斜杠，花括号，数学公式，数学符号，这是第一层子问题）
            - 描述：需求的具体描述，关键产出(KR)是什么，完成标准(CR)是什么，怎么判断是否正确完成
            - 是否叶子：False  // 非叶子任务，需要继续拆解
            - 子任务：
                - [ ] 目标Objective 1.1.1（⛔禁止特殊符号，尤其是反斜杠，花括号，数学公式，数学符号，这是第二层子问题）
                    - 描述：需求的具体描述，关键产出(KR)是什么，完成标准(CR)是什么，怎么判断是否正确完成
                    - 是否叶子：True
                - [ ] 目标Objective 1.1.2（⛔禁止特殊符号，尤其是反斜杠，花括号，数学公式，数学符号，这是第二层子问题）
                    - 描述：需求的具体描述，关键产出(KR)是什么，完成标准(CR)是什么，怎么判断是否正确完成
                    - 是否叶子：True
        - [ ] 目标Objective 1.2（⛔禁止特殊符号，尤其是反斜杠，花括号，数学公式，数学符号，这是第一层子问题）
            - 描述：需求的具体描述，关键产出(KR)是什么，完成标准(CR)是什么，怎么判断是否正确完成
            - 是否叶子：False  // 非叶子任务，需要继续拆解
            - 子任务：（仅当非叶子时存在）
                - [ ] 目标Objective 1.2.1（⛔禁止特殊符号，尤其是反斜杠，花括号，数学公式，数学符号，这是第二层子问题）
                    - 描述：需求的具体描述，关键产出(KR)是什么，完成标准(CR)是什么，怎么判断是否正确完成
                    - 是否叶子：True
                - [ ] 目标Objective 1.2.2（⛔禁止特殊符号，尤其是反斜杠，花括号，数学公式，数学符号，这是第二层子问题）
                    - 描述：需求的具体描述，关键产出(KR)是什么，完成标准(CR)是什么，怎么判断是否正确完成
                    - 是否叶子：True
- [ ] 目标Objective 2（⛔禁止特殊符号，尤其是反斜杠，花括号，数学公式，数学符号，这是第一层子问题）
    - 描述：需求的具体描述，关键产出(KR)是什么，完成标准(CR)是什么，怎么判断是否正确完成
