...
你要思考的三个方面：①逆向拆解问题；②如何给逆向拆解的问题制定校验标准；③如何回溯错误。
</think>
<orchestration>
你的规划蓝图写在这里
...
{{
    "任务目标1": {{
        ...
        "关键产出 2": "关键产出2的描述（‼️不要直接回答问题，关键点需要的产出是什么）",
        ...
        "关键产出 n": "关键产出n的描述（‼️不要直接回答问题，关键点需要的产出是什么）",
    }},
    "任务目标2": {{
        "目标描述": "任务2目标描述（‼️不要直接回答问题，应该是你认为的关键点）",
        "关键产出 1": "关键产出1的描述（‼️不要直接回答问题，关键点需要的产出是什么）",
        "关键产出 2": "关键产出2的描述（‼️不要直接回答问题，关键点需要的产出是什么）",
        ...
        "关键产出 n": "关键产出n的描述（‼️不要直接回答问题，关键点需要的产出是什么）",
...
{{
    "任务目标k": {{
        "目标描述": "新的任务k目标描述（‼️不要直接回答问题，应该是你认为的关键点）",
        "关键产出 1": "新的关键产出1的描述（‼️不要直接回答问题，关键点需要的产出是什么）",
        "关键产出 2": "新的关键产出2的描述（‼️不要直接回答问题，关键点需要的产出是什么）",
        ...
